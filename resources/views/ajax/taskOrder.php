...
<div class="task-info-wrp clearfix">
    ...
    <section class="task-info">
       <p class="task-status"><? echo 'Статус: '.$data->step_description; ?></p>
        <p>Находится в ожидании: <? echo $data->waiting." минут"; ?><small>(Добавлена: <? echo $data->at_; ?>)</small></p>
            ...
            <div class="tab-content">
                ...
                <div role="tabpanel" class="tab-pane" id="profile">
                    <form id="changeStatus">
                        ...
                        <textarea name="step_reason" required>Запрос менеджера</textarea>
    ...
    <section class="client-info">
        <?if(!empty($clientInfo['client'])){?>
        <h4>Клиент:</h4>
        <p><?php echo $clientInfo['client']->name; ?></p>
        <p><?php echo $clientInfo['client']->address; ?></p>
        <p><?php echo $clientInfo['client']->phone; ?></p>
        <p><?php echo $clientInfo['client']->city; ?></p>
        <?}?>
        <h4>История заказов:</h4>
        <?php
            foreach ($clientInfo['allDoc'] as $doc){
                ?>
                <a class="RDSmodal" data-toggle="modal" data-target="#RDSModal" id="allAboutRDS" href="#allAboutRDS" data-rds="<? echo $doc->number ?>"><? echo $doc->number ?></a>
                <?
            }
        ?>
        <h4>История обращений:</h4>
        <?php foreach($clientInfo['appealHis'] as $appeal=>$desc){
